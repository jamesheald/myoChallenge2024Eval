...
# from my_base_class_24 import BaseAlgorithm
from myochallenge24_my_base_class import BaseAlgorithm
...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    def _sample_action(
        ...
        if self.num_timesteps < learning_starts and not (self.use_sde and self.use_sde_at_warmup):
            ...
            unscaled_action, _ = self.predict(self._last_obs, deterministic=False) # phase_two
